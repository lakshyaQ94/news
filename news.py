...
class retronews:
    ...
    def __init__(self):
        ...
        # fetch data
        self.data = requests.get('https://newsapi.org/v2/everything?q=country&apikey=07ce6431517e45c5b04b589c36e5bed6').json()
        # initial GUI load
        self.load_gui()
    ...
    def load_gui(self):
        ...
        self.root.title('retronews')
        self.root.configure(background='#607D8B')
    ...
    def load_news_item(self,index):
        ...
        heading = Label(self.root,text=self.data['articles'][index]['title'],bg='grey',fg='white',wraplength=350,justify='center')
